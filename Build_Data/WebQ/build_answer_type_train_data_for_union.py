...
if __name__ == '__main__':
    fileName = BASE_DIR + '/runnings/train_data/webq/bert_webq_pairwise_40_5372_train_from5372.txt'
    que2AnswerInfo, que2TrueType = readQue2Types(fileName)
    data = fixAnswerErrorTypeTrue(fileName, que2AnswerInfo, que2TrueType)
    outFile = BASE_DIR + '/runnings/train_data/webq/bert_processing_type_webq_pairwise_40_5372_train_from5372.txt'
