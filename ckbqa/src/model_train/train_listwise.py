...
def test(best_model_dir_name, fout_res):
    ...
    eval_data = build_data_for_model(eval_examples, label_list, tokenizer, output_mode, device)
    # ************************** 
    file_name1 = '/'.join(best_model_dir_name.split('/')[0:-1]) + '/prediction'
    # import pdb; pdb.set_trace()
...
if __name__ == "__main__":
    ...
    for steps in [100]:
        ...
        parser.add_argument("--learning_rate",default=config['lr'],type=float,help="The initial learning rate for Adam.")
