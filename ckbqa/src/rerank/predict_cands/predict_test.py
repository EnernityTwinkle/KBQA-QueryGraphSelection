...
def test(best_model_dir_name, fout_res):
    ...
    eval_data = build_data_for_model(eval_examples, label_list, tokenizer, output_mode, device)
    # ************************** 
    file_name1 = '/'.join(best_model_dir_name.split('/')[0:-1]) + '/prediction_test_7538'
    # import pdb; pdb.set_trace()
...
if __name__ == "__main__":
    ...
    for steps in [100]:
        ...
        # for seed in [66, 666, 6666, 66666, 10000]:
            ...
            # parser.add_argument("--data_dir",default=BASE_DIR + '/data/train_data/stagg_ccks/',type=str)
            ...
            parser.add_argument("--t_file_name",default='testset_model_data.txt',type=str)
            ...
            # best_model_dir_name = '/home/chenwenliang/jiayonghui/ckbqa/src/model_train/models/pointwise_ccks_bert_trainexamples_devneg50_seq150_CE_neg20_24_42_1/0.9987708451815297_0.9020418788612581_4'
