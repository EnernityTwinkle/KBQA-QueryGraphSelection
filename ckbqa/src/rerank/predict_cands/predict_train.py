...
def convert_examples_to_features(examples, label_list, max_seq_length,
    ...
    for (ex_index, example_group) in enumerate(examples):
        ...
        for example in example_group:
            ...
            tokens_b = None
            if example.text_b:
                # text_b_list = [example.text_b['mainPath'], example.text_b['entityPath']]
                # text_b_list = [example.text_b['entityPath'], example.text_b['mainPath'],\
                ...
                text_b_list = [example.text_b['basePath'],\
                                example.text_b['higherOrderConstrain'],\
                                example.text_b['virtualConstrain'],\
...
def test(best_model_dir_name, fout_res):
    ...
    eval_data = build_data_for_model(eval_examples, label_list, tokenizer, output_mode, device)
    # ************************** 
    file_name1 = '/'.join(best_model_dir_name.split('/')[0:-1]) + '/prediction_train'
    # import pdb; pdb.set_trace()
...
if __name__ == "__main__":
    ...
    for steps in [100]:
        ...
        # for seed in [66, 666, 6666, 66666, 10000]:
            ...
            # parser.add_argument("--data_dir",default=BASE_DIR + '/data/train_data/ccks_9750_0308/',type=str)
            parser.add_argument("--data_dir",default=BASE_DIR + '/data/train_data/ccks_comp/',type=str)
            # parser.add_argument("--bert_model", default='/data4/yhchen/pretrained_model/chinese_roberta_wwm_large_ext_pytorch', type=str)
            # parser.add_argument("--bert_vocab", default='/data4/yhchen/pretrained_model/chinese_roberta_wwm_large_ext_pytorch', type=str)
            ...
            parser.add_argument("--output_dir",default='models/xstagg_ccks_listwise_bert_devneg100_seq150_CE_group_' + str(N) +\
            ...
            parser.add_argument("--T_file_name",default='train_neg' + str(N) + '.txt',type=str)
            parser.add_argument("--v_file_name",default='dev_20%_neg100.txt',type=str)
            parser.add_argument("--t_file_name",default='train_neg1000000.txt',type=str)
            ...
            # best_model_dir_name = '/home/chenwenliang/jiayonghui/ckbqa/src/model_train/models/7458_pointwise_ccks_bert_trainexamples_devneg50_seq150_CE_neg20_24_42_1/0.9987708451815297_0.9020418788612581_4'
            # best_model_dir_name = '/home/chenwenliang/jiayonghui/ckbqa/src/model_train/models/7538_ccks_listwise_bert_devneg100_seq150_CE_group_15_1_42_100/0.9929369461923719_0.9027111541155394_4'
            best_model_dir_name = '/home/chenwenliang/jiayonghui/ckbqa/src/model_train/models/7490_ccks_comp_listwise_bert_devneg100_seq150_CE_group_20_1_42_100/0.9910332178520481_0.8955343471284041_4'
            fout_res = open('/'.join(best_model_dir_name.split('/')[0:-1]) + '/result.log', 'a+', encoding='utf-8')
