...
if __name__ == "__main__":
    ...
    for N in [120]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/stage1_model/compq/comp-139_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)

        # 20220908
        parser.add_argument("--T_file_name",default='compq_rank1_f01_gradual_label_position_listwise_1_40_type_entity_time_ordinal_mainpath_is_train.txt',type=str)
