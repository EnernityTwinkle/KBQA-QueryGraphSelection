...
if __name__ == "__main__":
    ...
    # for N in [80, 100, 120, 140]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/stage1_model/webq/new_bert_webq_listwise_gradual_merge_type_entity_time_ordianl_mainpath_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
