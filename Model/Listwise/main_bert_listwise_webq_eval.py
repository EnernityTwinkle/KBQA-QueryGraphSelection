...
if __name__ == "__main__":
    ...
    for N in [40]:
        ...
        parser.add_argument("--data_dir",default=BASE_DIR + '/runnings/train_data/webq-yhjia/',type=str)
        # import pdb; pdb.set_trace()
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/webq/new_bert_webq_listwise_gradual_merge_type_entity_time_ordianl_mainpath_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
        ...
        # 0.54635 0.64009 0.55297
        best_model_dir_name = '/data4/cytan/KBQA-QueryGraphSelection/runnings/model/webq_stage1_5530_new_bert_webq_listwise_gradual_merge_type_entity_time_ordianl_mainpath_neg_40_42_100/0.8962974343217084_0.5700403872983646_1'
