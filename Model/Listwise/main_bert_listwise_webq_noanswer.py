...
if __name__ == "__main__":
    ...
    # for N in [80, 100, 120, 140]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/webq/new_bert_noanswer_webq_listwise_gradual_merge_type_entity_time_ordianl_mainpath_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
        parser.add_argument("--input_model_dir", default='0.9675389502344577_0.4803025192052977_3', type=str)
        
        parser.add_argument("--T_file_name",default='webq_rank1_f01_noanswer_gradual_label_position_1_' + str(N) + '_type_entity_time_ordinal_mainpath_is_train.txt',type=str)
        parser.add_argument("--v_file_name",default='webq_rank1_f01_noanswer_gradual_label_position_1_140_type_entity_time_ordinal_mainpath_dev_all.txt',type=str)
        parser.add_argument("--t_file_name",default='webq_rank1_f01_noanswer_gradual_label_position_1_140_type_entity_time_ordinal_mainpath_test_all.txt',type=str)
