...
if __name__ == "__main__":
    ...
    for N in [40]:
        ...
        parser.add_argument("--data_dir",default=BASE_DIR + '/runnings/train_data/compq-139/',type=str)
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/compq/new_bert_compq_listwise_rank1_f01_gradual_merge_type_entity_time_ordianl_mainpath_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
        ...
        fout_res = open('result.log', 'a', encoding='utf-8')
        # best_model_dir_name = main(fout_res)
        # 预测的模型位置
        # 0.43353689173361754 0.5574747023809524 0.4453694365654288
        best_model_dir_name = '/data4/cytan/KBQA-QueryGraphSelection/runnings/model/compq_stage1_4454_new_bert_compq_listwise_rank1_f01_gradual_merge_type_entity_time_ordianl_mainpath_neg_120_42_100/0.9380165289256198_0.4260429441640056_2'
