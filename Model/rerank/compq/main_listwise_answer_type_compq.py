...
if __name__ == "__main__":
    ...
    # for N in [20, 30, 40, 50, 60]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/compq/1layerrerank_listwise_with_answer_type_0503_compq_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
        ...
        # parser.add_argument("--T_file_name",default='compq_T_bert_constrain_pos_extra_ratio_6_top' + str(N) + '.txt',type=str)
