...
if __name__ == "__main__":
    ...
    # for N in [20, 30, 40, 50, 60]:
        ...
        parser.add_argument("--data_dir",default=BASE_DIR + '/runnings/train_data_rank/compq/',type=str)
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/compq/rerank_listwise_with_answer_type_random_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
