...
def main(fout_res, args: ArgumentParser):
    ...
    # import pdb; pdb.set_trace()   
    eval_data = processor.convert_examples_to_features_for_combine_answer(eval_examples, tokenizer)
    ...
    if args.do_train:   
        i_train_step = 0
        train_data = processor.convert_examples_to_features_for_combine_answer(train_examples, tokenizer)
...
if __name__ == "__main__":
    ...
    # for N in [5]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/webq/answer_info_rerank_2bert_webq_pointwise_2linear_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
