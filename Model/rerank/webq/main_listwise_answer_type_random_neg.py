...
if __name__ == "__main__":
    ...
    # for N in [100, 80, 60, 50, 40, 30, 20]:
        ...
        parser.add_argument("--data_dir",default=BASE_DIR + '/runnings/train_data_rank/webq/',type=str)
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/webq/rerank_listwise_with_answer_type_webq_0503random_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
        ...
        best_model_dir_name = '/home/chenwenliang/jiayonghui/gitlab/rerankinglab/runnings/model/webq/rerank_listwise_with_answer_type_webq_0503random_neg_40_42_100/0.9780304194192656_0.6550784335303784_4/'
