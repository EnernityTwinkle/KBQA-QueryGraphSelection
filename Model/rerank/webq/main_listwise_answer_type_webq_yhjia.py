...
if __name__ == "__main__":
    ...
    for N in [40]:
        ...
        parser.add_argument("--data_dir",default=BASE_DIR + '/runnings/train_data/webq_stage2/',type=str)
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/stage2_model/webq/0909_rerank_listwise_cat_mlp3_with_answer_type_1score_webq_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
        parser.add_argument("--input_model_dir", default='0.9675389502344577_0.4803025192052977_3', type=str)
        parser.add_argument("--T_file_name",default='5530_new_bert_webq_listwise_gradual_merge_type_entity_time_ordianl_mainpath_neg_40_42_100_train_from5530.txt',type=str)
        parser.add_argument("--v_file_name",default='5530_new_bert_webq_listwise_gradual_merge_type_entity_time_ordianl_mainpath_neg_40_42_100_dev_from5530.txt',type=str)
        parser.add_argument("--t_file_name",default='5530_new_bert_webq_listwise_gradual_merge_type_entity_time_ordianl_mainpath_neg_40_42_100_test_from5530.txt',type=str)
        ...
        # best_model_dir_name = '/home/chenwenliang/jiayonghui/gitlab/rerankinglab/runnings/model/webq/5566_rerank_listwise_with_answer_type_1score_webq_neg_60_42_100/0.7615894039735099_0.6161110135852773_3/'
