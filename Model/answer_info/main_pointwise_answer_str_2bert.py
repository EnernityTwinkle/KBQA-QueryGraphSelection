...
if __name__ == "__main__":
    ...
    # for N in [5]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/webq/answer_str_2bert_webq_pointwise_2linear_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
