...
if __name__ == "__main__":
    seed = 42
    steps = 100
    for N in [5, 10, 20, 30, 40, 50, 60, 70, 80, 100, 120]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/compq/bert_compq_pointwise_withans_rank1_f01_gradual_merge_type_entity_time_ordianl_mainpath_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
