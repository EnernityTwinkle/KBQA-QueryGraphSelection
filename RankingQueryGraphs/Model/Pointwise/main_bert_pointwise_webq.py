...
if __name__ == "__main__":
    ...
    for N in [5, 10, 20, 30, 40, 50, 60, 70, 80, 100, 120, 140]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/webq/bert_webq_pointwise_gradual_merge_type_entity_time_ordianl_mainpath_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
