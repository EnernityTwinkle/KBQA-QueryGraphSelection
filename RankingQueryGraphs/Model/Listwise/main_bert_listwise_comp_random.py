...
if __name__ == "__main__":
    ...
    for N in [50, 60, 70, 80, 100, 120, 140]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/compq/new_random_bert_compq_listwise_rank1_f01_gradual_merge_type_entity_time_ordianl_mainpath_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
