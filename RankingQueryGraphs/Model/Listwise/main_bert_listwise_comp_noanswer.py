...
if __name__ == "__main__":
    ...
    for N in [140, 120, 100, 80, 70, 60]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/compq/new_bert_noanswertrue1_compq_listwise_rank1_f01_gradual_merge_type_entity_time_ordianl_mainpath_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
        ...
        parser.add_argument("--T_file_name",default='compq_noanswer_rank1_f01_gradual_label_position_listwise_1_' + str(N) + '_type_entity_time_ordinal_mainpath_is_train.txt',type=str)
        parser.add_argument("--v_file_name",default='compq_noanswer_rank1_f01_gradual_label_position_listwise_1_140_type_entity_time_ordinal_mainpath_dev_all.txt',type=str)
        parser.add_argument("--t_file_name",default='compq_noanswer_rank1_f01_gradual_label_position_listwise_1_140_type_entity_time_ordinal_mainpath_test_all.txt',type=str)
