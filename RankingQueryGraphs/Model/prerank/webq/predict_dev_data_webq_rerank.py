...
def test(best_model_dir_name, fout_res):
    ...
    model = BertFor2PairSequenceWithAnswerType.from_pretrained(best_model_dir_name,cache_dir=cache_dir,num_labels=num_labels)
    model.to(device)
    # Prepare optimizer
    global_step = 0
    nb_tr_steps = 0
    ...
    # ************************** 
    file_name1 = args.output_dir + 'prediction_dev_rerank'
    ...
    if args.do_eval:
        ...
        f.flush()
        p, r, f = cal_f1(file_name1, args.data_dir + args.T_file_name, 'v', actual_num = 0)
        fout_res.write('precision:' + str(p) + '\trecall:' + str(r) + '\tf1:' + str(f) + '\n')
        fout_res.flush()

if __name__ == "__main__":
    # for seed in [42, 1000, 10000]:
    dirName = BASE_DIR + '/runnings/model/webq/'
    ...
    # model2file = {'rerank_listwise_baseline_1score_webq_neg_30_42_100/0.704635761589404_0.6486373392054795_2':'webq_with_answer_info_test_all.txt'}
    model2file = {'5595_rerank_listwise_negOrder_pos10_baseline_1score_webq_neg_30_42_100/0.7922378493857931_0.649495450113432_1':'webq_with_answer_info_dev_all.txt'}
    # model2file = {'5530_new_bert_webq_listwise_gradual_merge_type_entity_time_ordianl_mainpath_neg_40_42_100/0.8962974343217084_0.5700403872983646_1':'webq_with_answer_info_test_all.txt'}
