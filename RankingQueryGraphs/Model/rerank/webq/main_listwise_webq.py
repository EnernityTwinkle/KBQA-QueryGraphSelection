...
if __name__ == "__main__":
    ...
    # for N in [10, 20, 30, 40, 60, 80, 100]:
        logger = logging.getLogger(__name__)
        print(seed)
        os.environ["CUDA_VISIBLE_DEVICES"] = '5'
        parser = ArgumentParser(description = 'For KBQA')
        parser.add_argument("--data_dir",default=BASE_DIR + '/runnings/train_data_stage2/webq/',type=str)
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/webq/rerank_listwise_negOrder_pos10_baseline_1score_webq_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
        ...
        # parser.add_argument("--t_file_name",default='t_bert_top' + str(N) + '_from5530.txt',type=str)
        parser.add_argument("--T_file_name",default='webq_T_bert_negOrder_pos10_1_n_top' + str(N) + '.txt',type=str)
        ...
        best_model_dir_name = '/home/chenwenliang/jiayonghui/gitlab/rerankinglab/runnings/model/webq/5595_rerank_listwise_negOrder_pos10_baseline_1score_webq_neg_30_42_100/0.7922378493857931_0.649495450113432_1/'
