...
if __name__ == "__main__":
    ...
    # for N in [20, 30, 40, 50, 60]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/compq/rerank_listwise_with_answer_type_1_n_add_compq_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
        ...
        best_model_dir_name = '/home/chenwenliang/jiayonghui/gitlab/rerankinglab/runnings/model/compq/4406_rerank_listwise_with_answer_type_1_n_mlp3_compq_neg_20_42_100/0.9660433070866141_0.43522851983076444_4/'
