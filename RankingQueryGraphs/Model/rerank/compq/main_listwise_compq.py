...
def main(fout_res, args: ArgumentParser):
    ...
    model = BertForSequence.from_pretrained(args.bert_model,cache_dir=cache_dir,num_labels=1)
    model.to(device)
    # Prepare optimizer
...
def test(best_model_dir_name, fout_res, args):
    ...
    eval_data = processor.build_data_for_model(eval_data, tokenizer, device)
    # import pdb; pdb.set_trace()
    file_name1 = args.output_dir + 'prediction_xxxxx'
    f_valid = open(file_name1, 'w', encoding='utf-8')
    # Run prediction for full data
    eval_sampler = SequentialSampler(eval_data)
    eval_dataloader = DataLoader(eval_data, sampler=eval_sampler, batch_size=args.eval_batch_size)
...
if __name__ == "__main__":
    ...
    for N in [5, 10]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/compq/rerank_listwise_negOrder_pos10_baseline_1score_compq_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
        parser.add_argument("--input_model_dir", default='0.9675389502344577_0.4803025192052977_3', type=str)
        # parser.add_argument("--T_file_name",default='T_bert_top' + str(N) + '.txt',type=str)
        # parser.add_argument("--T_file_name",default='compq_T_bert_constrain_pos_extra_ratio_10_top' + str(N) + '.txt',type=str)
        parser.add_argument("--T_file_name",default='compq_T_bert_negOrder_pos10_1_n_top' + str(N) + '.txt',type=str)
        parser.add_argument("--v_file_name",default='v_bert_top' + str(N) + '.txt',type=str)
        parser.add_argument("--t_file_name",default='t_bert_top' + str(N) + '.txt',type=str)
        # parser.add_argument("--v_file_name",default='v_bert_top20.txt',type=str)
        # parser.add_argument("--t_file_name",default='t_bert_top20.txt',type=str)
        ...
        # parser.add_argument("--t_file_name",default='compq_test_all.txt',type=str)
        ...
        # parser.add_argument("--t_file_name",default='5530_new_bert_webq_listwise_gradual_merge_type_entity_time_ordianl_mainpath_neg_40_42_100_dev_from5530.txt',type=str)
        ...
        # best_model_dir_name = '/home/chenwenliang/jiayonghui/gitlab/rerankinglab/runnings/model/compq/4413_rerank_listwise_ration6_true_baseline_1score_compq_neg_20_42_100/0.692_0.43039912435650857_4/'
        # best_model_dir_name = '/home/chenwenliang/jiayonghui/gitlab/rerankinglab/runnings/model/compq/4447_rerank_listwise_negOrder_baseline_1score_compq_neg_60_42_100/0.9770848985725019_0.4329372187177066_4/'
        best_model_dir_name = '/home/chenwenliang/jiayonghui/gitlab/rerankinglab/runnings/model/compq/4562_rerank_listwise_negOrder_pos10_baseline_1score_compq_neg_40_42_100/0.9168307086614174_0.45090158474942627_2/'
