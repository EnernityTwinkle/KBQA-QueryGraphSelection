...
if __name__ == "__main__":
    ...
    # for N in [140]:
        # file_name = '../../bert_rank_data/compq/compq_rank1_f01_p01_label_position_listwise_1_' + str(N) + '_type_entity_time_ordinal_mainpath_'
        file_name = BASE_DIR + '/runnings/train_data/compq/compq_rank1_f01_gradual_label_position_listwise_1_' + str(N) + '_type_entity_time_ordinal_mainpath_'
        # file_name = BASE_DIR + '/runnings/train_data/compq/compq_noanswer_rank1_f01_gradual_label_position_listwise_1_' + str(N) + '_type_entity_time_ordinal_mainpath_'
    ...
    dev_data = select_top_1_n_listwise(qid2question, qid2cands_train, pos_only1=False, data_type='v', N=N)
