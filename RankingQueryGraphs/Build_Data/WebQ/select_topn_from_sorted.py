...
if __name__ == "__main__":
    ...
    for top_n in [5, 10, 20, 30, 40, 50, 60, 80, 100]:
        ...
        file_name = dirName + '5530_new_bert_webq_listwise_gradual_merge_type_entity_time_ordianl_mainpath_neg_40_42_100_dev_from5530.txt'
        qid2data = get_top_n(file_name, top_n)
        write2file(dirName + 'v_bert_top' + str(top_n) + '_from5530.txt', qid2data, 'T')
